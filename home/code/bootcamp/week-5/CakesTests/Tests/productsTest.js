...
class ProductsTest {
    ...
    async testPageUp() {
        ...
        await productsPage.openProductsPage();
        try {
            await productsPage.pressUp(["Chocolate Cake", "Apple Pie"], ["Vanilla Cake", "Red Valvet Cake"])
        } catch (error) {
            console.error(error);
        }
    ...
    async testPageDown() {
        ...
        await productsPage.openProductsPage();
        try {
            await productsPage.pressDown(["Chocolate Cake", "Apple Pie"], ["Lemon Blueberry Cake", "New York Cheese Cake"])
        } catch (error) {
            console.error(error);
        }
