...
class HomeTest {
    ...
    async testAdvancedSearchV2() {
        ...
        const homePage = new HomePage();
        await homePage.openHomePage();
        await homePage.advancedSearch(inputsData.cakeTypes, inputsData.cakeRates, inputsData.dateOfUpload, inputsData.allTheseWords, inputsData.exactWords);
        await homePage.closeHomePage()
    }
